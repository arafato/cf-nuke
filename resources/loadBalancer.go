...
func init() {
	infrastructure.RegisterZoneCollector("load-balancer", CollectLoadBalancers)
}
...
func CollectLoadBalancers(creds *types.Credentials, zone *types.Zone) (types.Resources, error) {
